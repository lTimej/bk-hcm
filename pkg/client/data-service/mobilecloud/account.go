...
// Get mobilecloud account detail.
func (a *AccountClient) Get(ctx context.Context, h http.Header, accountID string) (
	*protocloud.AccountGetResult[protocore.MobileCloudAccountExtension], error,
) {

	resp := new(protocloud.AccountGetResp[protocore.MobileCloudAccountExtension])
