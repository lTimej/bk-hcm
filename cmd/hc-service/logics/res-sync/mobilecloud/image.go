...
// Image ...
func (cli *client) Image(kt *kit.Kit, opt *imsmodel.ListServerPublicImageV2Query, runtimeConfig *config.RuntimeConfig) (*imsmodel.ListServerPublicImageV2Response, error) {
	resp, err := cli.cloudCli.ListPublicImages(kt, opt, runtimeConfig)
	return resp, err
}
